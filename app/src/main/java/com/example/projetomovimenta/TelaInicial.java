...
import com.example.projetomovimenta.databinding.TelaInicialBinding;
...
public class TelaInicial extends AppCompatActivity {
    ...
    private TelaInicialBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        binding = TelaInicialBinding.inflate(getLayoutInflater());
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.academias, R.id.localizacao, R.id.equipamentos, R.id.imc, R.id.saude)
